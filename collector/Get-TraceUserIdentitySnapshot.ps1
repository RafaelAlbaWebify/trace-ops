...
if ($sample.PSObject.Properties.Name -notcontains "identity") {
    New-TraceSnapshotLimitation -Area "identity" -Scenario $requestedScenario | ConvertTo-Json -Depth 20
    exit 0
}
