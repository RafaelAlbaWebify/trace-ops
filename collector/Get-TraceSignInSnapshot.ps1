...
if ($sample.PSObject.Properties.Name -notcontains "signin_logs") {
    New-TraceSnapshotLimitation -Area "signin_logs" -Scenario $requestedScenario | ConvertTo-Json -Depth 20
    exit 0
}
...
[ordered]@{
    ...
    evidence_area = "signin_logs"
    signin_logs = $sample.signin_logs
} | ConvertTo-Json -Depth 20
