...
if ($sample.PSObject.Properties.Name -notcontains "device") {
    New-TraceSnapshotLimitation -Area "device" -Scenario $requestedScenario | ConvertTo-Json -Depth 20
    exit 0
}
